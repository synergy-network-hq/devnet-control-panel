# Closed Devnet Observability Stack
...
- Promtail tails local logs from `data/devnet15/*/logs`. For multi-machine clusters, deploy promtail/node-exporter on each node and keep scrapes on the monitor host.

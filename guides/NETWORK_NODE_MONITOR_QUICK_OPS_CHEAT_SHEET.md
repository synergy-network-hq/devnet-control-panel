# Network Node Monitor Quick Ops Cheat Sheet
...
- App workspace (macOS): `~/.synergy-node-monitor/monitor-workspace`
- App workspace (Linux): `~/.synergy-node-monitor/monitor-workspace`
- App workspace (Windows): `%USERPROFILE%\.synergy-node-monitor\monitor-workspace`
...
5. Start nodes by groups:
   - validators (`machine-01`..`machine-05`)
   - governance (`machine-10`,`machine-11`)
   - interop (`machine-06`..`machine-09`)
   - pqc (`machine-12`)
   - services (`machine-13`..`machine-15`)
